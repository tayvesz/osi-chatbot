...
if std_count == 3000:
    st.warning("⚠️ **DEMO MODE ACTIVE**: You are currently exploring a **fictitious** dataset generated for testing purposes. Real ISO standards are not loaded.")
...
if not os.environ.get("GROQ_API_KEY"):
    st.info("👋 Welcome! Please configure your API Key in the sidebar to proceed.")
    st.stop()
...
with col1:
    st.button("🔐 Cybersecurity (ISO 27001)", 
...
with col2:
    st.button("🤖 Artificial Intelligence", 
             ...
             use_container_width=True)
with col3:
    st.button("🌍 Environment (ISO 14001)", 
             on_click=handle_click, 
